...
function Header(props) {
  ...
  const menu0 = (
    <Menu>
        ...
        <Menu.Item className="mob_menu_text">
          ...
          <Link to={!user && "/login"}>
            ...
            <div onClick={handleAuthentication} className="header__option">
              <span className="My_account_mobile">{email}</span>
              <span className="My_account_mobile">
      ...
      <Link to="/orders">
      <Menu.Item className="mob_menu_text" ><img
      className="icons"
      src="https://www.flaticon.com/svg/static/icons/svg/3500/3500833.svg"
      alt=""
    ></img> Orders</Menu.Item>
      </Link>
      <Link to="/stores">
      <Menu.Item className="mob_menu_text"><img
      className="icons"
      src="https://www.flaticon.com/svg/static/icons/svg/2922/2922778.svg"
      alt=""
    ></img>Store Locations</Menu.Item>
      </Link>
      <Link to="/contact-us">
      <Menu.Item className="mob_menu_text"><img
      className="icons"
      src="https://www.flaticon.com/svg/static/icons/svg/552/552486.svg"
      alt=""
    ></img>Contact Us</Menu.Item>
      </Link>
    </Menu>
  );
  ...
  const menu13 = (
    <Menu>
      <Menu.Item> THE FESTIVAL SHOP</Menu.Item>
  ...
  const menu15 = (
    ...
    <Link to="/grocery">
      ...
      <SubMenu title="FRUITS & VEGETABLES">
      <Link to="/fruits">
        <Menu.Item className="sub_menu_text">Fresh Fruits</Menu.Item>
        </Link>
        <Link to="/vegetables">
        <Menu.Item className="sub_menu_text">Fresh Vegetables</Menu.Item>
        </Link>
      </SubMenu>
      
      <SubMenu title="MEAT & FISH">
        <Menu.Item>
        Meat
        </Menu.Item>
        <Menu.Item>Fresh Fish
        </Menu.Item>
        <Menu.Item>Dried Fish
        </Menu.Item>
        <Menu.Item>Tofu & Meat Alternatives
        </Menu.Item>
      </SubMenu>
      <SubMenu title="COOKING">
        <Menu.Item>Rice</Menu.Item>
        <Menu.Item>Premium Ingredients</Menu.Item>
        <Menu.Item>Colors & Flavours</Menu.Item>
        <Menu.Item>Pickles</Menu.Item>
        <Menu.Item>Spices</Menu.Item>
        <Menu.Item>Oil</Menu.Item>
        <Menu.Item>Ghee</Menu.Item>
        <Menu.Item>Ready MiX</Menu.Item>
        <Menu.Item>Salt & Sugar</Menu.Item>
        <Menu.Item>Spices</Menu.Item>
        <Menu.Item>Dal or Lentil</Menu.Item>
        <Menu.Item>Special Ingredients</Menu.Item>
        <Menu.Item>Shemai & Suji</Menu.Item>
      </SubMenu>
      <SubMenu title="FOOD">
      ...
      <Menu.Item>Fruits & Vegetables</Menu.Item>
        <Menu.Item>Meat & Fish</Menu.Item>
        <Menu.Item>Dairy</Menu.Item>
        <Menu.Item>Frozen & Canned</Menu.Item>
        <Menu.Item>Bread & Bakery</Menu.Item>
        <Menu.Item>Baking Needs</Menu.Item>
        <Menu.Item>Cooking</Menu.Item>
        <Menu.Item>Diabetic Food</Menu.Item>
      </SubMenu>
      <SubMenu title="BEVERAGE">
        <Menu.Item>Tea</Menu.Item>
        <Menu.Item>Coffee</Menu.Item>
        <Menu.Item>Juice</Menu.Item>
        <Menu.Item>Soft Drinks</Menu.Item>
        <Menu.Item>Water</Menu.Item>
        <Menu.Item>Syrups & Powder Drinks</Menu.Item>
      </SubMenu>
      <SubMenu title="CLEANING SUPPLIES">
        <Menu.Item>Air Fresheners</Menu.Item>
        <Menu.Item>Dish Detergents</Menu.Item>
        <Menu.Item>Kitchen Accessories</Menu.Item>
        <Menu.Item>Laundry</Menu.Item>
        <Menu.Item>Napkins & Paper Products</Menu.Item>
        <Menu.Item>Pest Control</Menu.Item>
        <Menu.Item>Shoe Care</Menu.Item>
        <Menu.Item>Tableware & Trash Bags</Menu.Item>
        <Menu.Item>Food Storage</Menu.Item>
        <Menu.Item>Cleaning Accessories</Menu.Item>
      </SubMenu>
      <SubMenu title="PERSONAL CARE">
      <Menu.Item>Bath</Menu.Item>
      <Menu.Item>Cream & Lotion</Menu.Item>
      <Menu.Item>Facial Care</Menu.Item>
      <Menu.Item>Beard Grooming</Menu.Item>
      <Menu.Item>Clothing Essentials</Menu.Item>
      <Menu.Item>Deodorants</Menu.Item>
      <Menu.Item>Shaving Needs</Menu.Item>
      <Menu.Item>Hair Care</Menu.Item>
      <Menu.Item>Oral Care</Menu.Item>
      <Menu.Item>Feminine Care</Menu.Item>
      <Menu.Item>Skin Care</Menu.Item>
      <Menu.Item>Shampoo</Menu.Item>
      <Menu.Item>Handwash</Menu.Item>
      <Menu.Item>Tissue & Wipes</Menu.Item>
      <Menu.Item>Talcom Powder</Menu.Item>
      </SubMenu>
      <SubMenu title="BABY CARE">
        <Menu.Item>Shop All</Menu.Item>
        <Menu.Item>Further Reductions</Menu.Item>
      </SubMenu>
      <SubMenu title="PET SUPPLIES">
      <Menu.Item>Kitten Food</Menu.Item>
      <Menu.Item>Cat Food</Menu.Item>
      <Menu.Item>Dog Food</Menu.Item>
      <Menu.Item>Other Pet Foods</Menu.Item>
      <Menu.Item>Pet Accessories</Menu.Item>
    </SubMenu>
    </Menu>
  );
  return (
    <div className="header">
      <div className="header-contents">
          ...
          <Link to="/checkout">
            <span className="cart_mobile">
              <img
                ...
                alt=""
              ></img>
              <span className="basket_amount">{basket.length}</span>
            </span>
          </Link>
        ...
        <div className="right_side">
          ...
          <Link to={!user && "/login"}>
            ...
            <div onClick={handleAuthentication} className="header__option">
              <span className="My_account">{email}</span>
          ...
          <Link to ="/orders" className="Help">
          <span >Orders</span>
          </Link>
          <Link to ="/stores" className="Help">
      ...
      <div className="menu_products">
        ...
        <Dropdown overlay={menu15}>
          <a
            className="ant-dropdown-link_red"
            onClick={(e) => e.preventDefault()}
          >
            GROCERIES
          </a>
